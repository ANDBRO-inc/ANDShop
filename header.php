...
<body <?php body_class(); ?>>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PS922CH" height="0" width="0"
  ...
  <div id="page" class="site">
    ...
    <header itemtype="https://schema.org/WPHeader" itemscope="itemscope" id="masthead"
      class="site-header ast-primary-submenu-animation-slide-down header-main-layout-1 ast-primary-menu-enabled ast-hide-custom-menu-mobile ast-menu-toggle-icon ast-mobile-header-inline"
      role="banner">
            ...
            <div class="ast-flex main-header-container">
              ...
              <div class="top-header">
                ...
                <div class="right pc-right">
                  <ul id="primary-menu"
                    class="main-header-menu ast-nav-menu ast-flex ast-justify-content-flex-end  submenu-with-border astra-menu-animation-slide-down "
                    aria-expanded="false">
                    <li id="menu-item-797"
                      class="nav-HeaderSub_Guide menu-item menu-item-type-post_type menu-item-object-page menu-item-797">
                    ...
                    <li id="menu-item-798"
                      class="nav-HeaderSub_Cart menu-item menu-item-type-post_type menu-item-object-page menu-item-798">
                    ...
                    <!-- ログイン中 -->
                    <li id="menu-item-800"
                      class="nav-HeaderSub_Mypage menu-item menu-item-type-post_type menu-item-object-page menu-item-800">
              ...
              <div class="ast-mobile-menu-buttons">
                <div class="ast-button-wrap">
                  <button type="button" class="menu-toggle main-header-menu-toggle ast-mobile-menu-buttons-minimal"
